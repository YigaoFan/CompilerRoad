...
int main()
{
    ...
    //print("{}", mdfa);
    //std::cout << "OK";
    std::array rules = { pair<Token, string>{ Token::Id, "[a-zA-Z][a-zA-Z0-9_]*" } };
    //std::array rules = { pair<Token, string>{ Token::Id, "[a-bA-B][a-bA-B0-1_]*" } }; // for get simple relation of above graph
    //std::array rules = { pair<Token, string>{ Token::Id, "[a-zA-Z][0-9_]*" } };
